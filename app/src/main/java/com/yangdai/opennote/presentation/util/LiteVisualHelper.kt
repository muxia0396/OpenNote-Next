...
val SEARCH_WORD_STYLE = SpanStyle(
    background = Color(0xFFFFFF00).copy(alpha = 0.55f),
    color = Color.Black
)
val CURRENT_SEARCH_WORD_STYLE = SpanStyle(
    background = Color(0xFFFFFF00).copy(alpha = 0.9f),
    color = Color.Black
)
