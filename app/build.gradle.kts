...
android {
    ...
    buildTypes {
        release {
            ...
            // Produce an installable, cryptographically signed release APK for local distribution.
            // Store-distributed builds should replace this with the owner's private release key.
